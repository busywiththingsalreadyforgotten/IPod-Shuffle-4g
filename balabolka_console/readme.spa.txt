Balabolka (aplicación de consola), versión 1.25
...
-id <entero>
   Establece el identificador de idioma (Locale ID) de la voz. El identificador de idioma es el código de idioma asignado por Microsoft (por ejemplo, "1033" para "inglés - Estados Unidos" o "3082" para "español -alfabetización internacional).
   ...
   Lista de identificadores de idioma: http://msdn.microsoft.com/en-us/goglobal/bb964664.aspx
...
balabolka_console.exe -f "d:\Texto\libro.txt" -w "d:\Sonido\libro.wav" -n "Emma"

balabolka_console.exe -n "Callie" -c -d "d:\rex\reglas.rex" -d "d:\dic\reglas.dic"

balabolka_console.exe -n "Conchita" -t "El texto será leído lentamente." -s -5 -v 70

balabolka_console.exe -k

balabolka_console.exe -f "d:\Texto\libro.txt" -w "d:\Sonido\libro.wav" -lrc --lrc-length 80 --lrc-title "El Señor de los Anillos"

balabolka_console.exe -f "d:\Texto\film.srt" -w "d:\Sonido\film.wav" -n "Laura" --sub-fit --sub-max 2


Ejemplo de utilización de la aplicación junto con la utilidad LAME.EXE:

balabolka_console.exe -f d:\libro.txt -n Ines -o --raw | lame.exe -r -s 22.05 -m m -h - d:\libro.mp3


Ejemplo de utilización de la aplicación junto con la utilidad OGGENC2.EXE:

balabolka_console.exe -f d:\libro.txt -n Ines -o --ignorelength | oggenc2.exe --ignorelength - -o d:\libro.ogg


Ejemplo de utilización de la aplicación junto con la utilidad WMAENCODE.EXE:

balabolka_console.exe -f d:\libro.txt -n Ines -o --ignorelength | wmaencode.exe - d:\libro.wma --ignorelength


*** Archivo de configuración ***

Se puede guardar el archivo de configuración "balabolka_console.cfg" en la misma carpeta que la aplicación de consola.
