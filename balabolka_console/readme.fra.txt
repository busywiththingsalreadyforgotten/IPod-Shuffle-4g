...
-id <nombre_intégral>
   Spécifier le code de langue pour la voix (Locale ID). Locale ID est le code de langue attribué par Microsoft (par exemple "1033" pour Anglais - États-Unis", "1036" pour "Français - France").
...
Les options de ligne de commande peuvent être enregistrées en tant que fichier de configuration « balabolka_console.cfg » dans le même dossier que l'application console.
