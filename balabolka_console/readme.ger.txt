Balabolka (Konsolenanwendung), Version 1.25
...
-id <Zahl>
   Setzt die "Lokale ID" für die Stimme. Die Lokale ID ist der von Microsoft zugewiesene Sprachen-Code (z. B. "1031" für "Deutsch - Deutschland", "1033" für "Englisch - Amerika").
...
Die Befehlszeilen-Optionen können als Konfigurationsdatei "balabolka_console.cfg" im Ordner der Konsolen-Anwendung gespeichert werden. 
